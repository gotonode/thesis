...
In this thesis, reasons why people fail and succumb to social engineering attacks are discussed from a psychological perspective as well.

As attackers are continously innovating, so too must the defenders, but there's a limit to how much a end user can assimilate and when their tolerance for more and more training fills up

As we'll see, people's choice not to follow security guidelines in their strictest form may be rational from a behavioral economics standpoint.
...
%% TODO: Do I need to include the abstract in Finnish as well?
