...
Certain SE attacks and tactics that are of particular interest when it comes to the modern threat of AI were chosen for more in-depth analysis, such as spear phishing and deepfake-generated content, while leaving other attacks with less focus, such as dumpster diving, shoulder surfing, and tailgating.

%The essay discusses countermeasures, emphasizing the need to enhance current cybersecurity training and awareness programs to address the modern AI threat. The primary focus is on the human aspect of SE, while the technical details of AI tools and techniques are beyond the scope of this essay.
...
Chapter \ref{chapter:attacks} examines common attack methods and vectors, such as spear phishing, and explores how modern AI capabilities amplify their effectiveness.
