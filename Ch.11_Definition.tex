...
\begin{itemize}
    ...
    \item \textit{Social Proff}: People do tend to follow the actions of others, especially in uncertain situations ("herd mentality"). Social proof thus suggests that individuals look to others to determine what is correct or appropriate behavior.% When someone else, such as the attacker's partner, is witnessed giving away their PIN code, the likelyhood of the witnessing parties to do the same may increase.
