...
%The field of social engineering contains a plethora of attacks, and for the purposes of this essay, this selection had to be narrowed down. Due to their relevance, phishing it its various forms, deepfake-generated content and automated OSINT were chosen for a more in-depth analysis.
...
AI technologies, such as machine learning, can be employed to craft even more precise and spelling-error free scam messages.
...
Deepfake, a portmanteau of "deep learning", a type of machine learning, and "fake", is technology which uses artificial intelligence to create highly convincing fake media, either by altering existing media or creating them from scratch. Deepfake content can by images, audio and video.
