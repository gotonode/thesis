...
\documentclass[english,twoside,censored,tkt,null]{HYthesisML} 
...
\title{[DRAFT] AI-powered Social Engineering}
...
\keywords{social engineering, artificial intelligence, AI, cybersecurity, security, hacking, psychology}
%\additionalinformation{\translate{\track}}
\additionalinformation{Thesis contains a Finnish language summary and information on the use of AI technologies.}
...
\include{Ch.0_Finnish}

%% Chapters

\include{Ch.1_Introduction}
\include{Ch.2_Definition}
\include{Ch.3_Methods}
\include{Ch.4_Countermeasures}
\include{Ch.5_Evaluation}
\include{Ch.6_Conclusions}
