...
\title{A Novel Cybersecurity Threat: Artificial Intelligence in Social Engineering}
...
\supervisors{Dr. Lea Kutvonen}

\keywords{social engineering, artificial intelligence, cybersecurity, security, hacking, psychology}
...
\  Social and professional topics $\rightarrow$ Computing / technology policy  $\rightarrow$ Computer crime \\ $\rightarrow$ Social engineering attacks \\
...
\  Security and privacy $\rightarrow$ Intrusion/anomaly detection and malware mitigation \\ $\rightarrow$ Social engineering attacks
}}
