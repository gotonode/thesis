...
Advanced deepfake technology was famously used in a 2024 incident in a live video conference where the attackers successfully scammed an organization for~\$25 million\footnote{https://incidentdatabase.ai/cite/634 (visited on 2024-08-24)}.% lisää tähän toinen esimerkki, toinen lause?




\section{Phishing via calls}
\begin{comment}
\end{comment}
